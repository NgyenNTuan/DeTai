...
public class GiaoDienQuanLyNhaCungCap extends JFrame implements ActionListener, MouseListener {
	...
	private JButton btnThem, btnCapNhat, btnTroVe, btnTimKiem , btnXoaRong;
	...
	public GiaoDienQuanLyNhaCungCap() {
		...
		btnThem.setBounds(21, 39, 89, 23);
		panel_1.add(btnThem);

		btnCapNhat = new JButton("Cập Nhật");
		btnCapNhat.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnCapNhat.setBounds(130, 39, 97, 23);
		...
		btnXoaRong.setBounds(248, 41, 112, 23);
		...
		btnTimKiem.setIcon(new ImageIcon("C:\\DeTaiPhatTrienUngDung\\QuanLyThueBangDia\\icon\\icons8-search-48.png"));
